...
Detailed setup, automation, storage, backup, and release reference.
For the product overview and visual tour, see the [README](../README.md).
...
See [docs/CLI.md](CLI.md) for complete workflow examples and
[docs/AGENT_GUIDE.md](AGENT_GUIDE.md) for the non-interactive contract.
