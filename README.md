...
| **Local app, browser, and CLI** | Run the Windows app, macOS app, or a source checkout, with optional authenticated remote access and built-in documentation. |
...
| [Windows app](docs/WINDOWS.md) | Portable download, launcher, bundled CLI, data folders, and troubleshooting |
